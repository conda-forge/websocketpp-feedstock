...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/websocketpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/websocketpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add websocketpp
# for installing globally
pixi global install websocketpp
```
...
It is possible to list all of the versions of `websocketpp` available on your platform:
...
```
pixi search websocketpp --channel conda-forge
```
